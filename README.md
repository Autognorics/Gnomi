...
One of the LAWS intutive network is the basic aneural system below:
...
Thus, it is not always true that the brain is the only place that stores and processes information. In fact, there are so many ways where information is stored and processed without the help of the brain (see Intuitive Networks)
